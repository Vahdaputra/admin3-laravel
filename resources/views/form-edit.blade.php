...
<div class="pagetitle">
 ...
 <div class="col-12">
      ...
      <input type="text" name="ket" value="{{ $data_pemasukan['keterangan'] }}" class="form-control" id="keterangan">
    </div>
    @error('ket')
...
@enderror
    <div class="col-12">
      ...
      <input type="date" value="{{$data_pemasukan['tanggal']}}" name="tgl" class="form-control" id="tanggal">
    </div>
    @error('tgl')
    <div class="alert alert-danger">{{ $message }}</div>
@enderror
    <div class="col-12">
      ...
      <input type="text" value="{{$data_pemasukan['jumlah']}}" name="jml" class="form-control" id="jumlah">
    </div>
    @error('jml')
    <div class="alert alert-danger">{{ $message }}</div>
@enderror
